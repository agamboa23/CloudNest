...
(function() {
    "use strict";
    var template = '<div id="country-select">';
    template += '<div class="bloc-country country-text  mdl-textfield">';
    template += '<label class="form-label" for="country">{{countryLabel}}</label>';
    ...
    template +='</select>';
    template +='</div>';
    template +='<div class="bloc-state country-text mdl-textfield">';
    template +='<label class="form-label" for="state" ng-show="states">{{stateLabel}}</label>';
        ...
        .directive("countryStateSelect", [ function () {
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    scope.countrySelectLabel = "Custom";
                    scope.states = ["Select Country first"];
                    ...
                    scope.selectCountry = function(){
                        ...
                        if(indexCountry == 0){
                        	var textInputs= '<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">';
							textInputs +='<input class="mdl-textfield__input" ng-model="newLocation.country" type="text" id="regionName">';
							textInputs +='<label class="mdl-textfield__label" for="regionName">Country:</label>';
							textInputs +='</div>';
					  		textInputs +='<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">';
							textInputs +='<input class="mdl-textfield__input" ng-model="newLocation.state" type="text" id="regionDescription">';
							textInputs +='<label class="mdl-textfield__label" for="regionName">State:</label>';
							textInputs +='</div>';
                        	$('#country-select').replaceWith(textInputs);
